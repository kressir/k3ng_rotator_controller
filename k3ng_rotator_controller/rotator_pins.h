...
#define rotate_cw 0//6              // goes high to activate rotator R (CW) rotation - pin 1 on Yaesu connector
#define rotate_ccw 0//7             // goes high to activate rotator L (CCW) rotation - pin 2 on Yaesu connector
...
#define brake_az 8 //6               // goes high to disengage azimuth brake (set to 0 to disable)
...
#define blink_led 13
#define az_stepper_motor_pulse 5 //2
#define az_stepper_motor_direction 2 //3



/*----------- elevation pins --------------*/
#ifdef FEATURE_ELEVATION_CONTROL
  #define rotate_up 0//8               // goes high to activate rotator elevation up
  #define rotate_down 0//9             // goes high to activate rotator elevation down
  ...
  #define rotator_analog_el A0      // reads analog elevation voltage from rotator
  ...
  #define brake_el 8 //6                // goes high to disengage elevation brake (set to 0 to disable)
  ...
  #define el_stepper_motor_pulse  6 //4
  #define el_stepper_motor_direction 3 //5
